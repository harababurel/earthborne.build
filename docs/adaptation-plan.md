...
- **`frontend/src/assets/campaign-guides.html`, `one-day-missions.html`, `updates.html`, `faq.html`** — Added top-level Living Valley reference sections. Generated by `scripts/scrape-reference-sections.mjs`.
...
- **`scripts/scrape-reference-sections.mjs`** — New script: re-run `node scripts/scrape-reference-sections.mjs` to regenerate the other Living Valley reference section assets.
