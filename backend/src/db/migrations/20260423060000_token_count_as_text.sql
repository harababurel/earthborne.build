...
SELECT
  id, code, pack_id, category_id, set_id, set_position, position, quantity, deck_limit, type_id, aspect_id, level, cost, equip, presence, harm, progress, progress_fixed, approach_conflict, approach_reason, approach_exploration, approach_connection, aspect_awareness, aspect_fitness, aspect_focus, aspect_spirit, token_id, CAST(token_count AS TEXT), area_id, guide_entry, locations, back_card_id, illustrator, spoiler, name, traits, text, flavor, objective, imagesrc, image_rect, sun_challenge, mountain_challenge, crest_challenge
FROM card_old;
...
SELECT
  id, code, pack_id, category_id, set_id, set_position, position, quantity, deck_limit, type_id, aspect_id, level, cost, equip, presence, harm, progress, progress_fixed, approach_conflict, approach_reason, approach_exploration, approach_connection, aspect_awareness, aspect_fitness, aspect_focus, aspect_spirit, token_id, CAST(token_count AS INTEGER), area_id, guide_entry, locations, back_card_id, illustrator, spoiler, name, traits, text, flavor, objective, imagesrc, image_rect, sun_challenge, mountain_challenge, crest_challenge
FROM card_old;
