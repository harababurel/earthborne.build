...
export function MissionsTab({ campaign }: { campaign: Campaign }) {
  ...
  const visibleMissions = campaign.missions
    ...
    .filter(({ mission }) => !hideCompleted || !mission.completed);
    ...
    <div className={css["section"]}>
      <div className={css["toolbar"]}>
        ...
        <Checkbox
          ...
          label={t("campaign.missions.hide_completed")}
      ...
      {campaign.missions.length ? (
        visibleMissions.length ? (
          <ul className={css["mission-list"]}>
            ...
            {visibleMissions.map(({ index, mission }) => {
          ...
          <p className={css["empty"]}>{t("campaign.missions.none_visible")}</p>
        )
      ) : (
